    ...
    <div class="zhuiz">
        ...
        <div class="top">
            <div class="left">
                <div class="item">
                    <b>来源： </b>
                    <Select v-model="model8" clearable style="width: 150px">
                        <Option
        ...
        <div class="tablebox1">
            <div class="top1">
                <div class="topxin">
                    ...
                    <Button type="primary" @click="$router.push(`/fankui?text=${index}`)">进度反馈</Button>
                </div>
            </div>
            <div class="tablexin">
                <Table border  :columns="columns1" :data="data1" highlight-row=true disabled-hover @on-row-click="fn2" height="600">
                    <template slot-scope="{ row }" slot="text">
                        <Poptip trigger="hover" word-wrap  width="450"  :content="row.text">
                        <div style="width:500px; cursor: pointer; white-space: nowrap;
                    overflow: hidden;
                    text-overflow: ellipsis;">{{ row.text }}</div>
                        </Poptip>
                    </template>
                     <template slot-scope="{ row,index }" slot="number">
                         <Poptip trigger="hover"  width="200" content="点击查看附件">
                        <span style="cursor: pointer;color:red;font-width:800;font-size:16px" @click="goupdata(index)">{{ row.number }}</span>
                         </Poptip>
                    </template>
                </Table>
